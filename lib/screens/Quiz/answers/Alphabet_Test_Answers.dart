...
class AlphabetTestAnswers extends StatelessWidget {
  AlphabetTestAnswers({super.key});

  final List<AlphabetTestQuestions> questionList =
      getAlphabetTestQuestionList();

  correctAnswer(AlphabetTestQuizAnswers answer, int index) {
    String result = '';
    if (answer.isCorrect) {
