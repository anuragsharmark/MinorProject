import 'package:asaan/screens/Quiz/questionsModal/AlphabetTestQuestions.dart';
...
class SyllogismQuizAnswers extends StatelessWidget {
  SyllogismQuizAnswers({super.key});

  final List<SyllogismQuestions> questionList = getSyllogismList();

  correctAnswer(SyllogismAnswers answer, int index) {
    String result = '';
    if (answer.isCorrect) {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // ElevatedButton(
                  //     onPressed: () {}, child: Text('Move to Next Quiz ➔'))
                ],
              ),
            ),
            Expanded(
