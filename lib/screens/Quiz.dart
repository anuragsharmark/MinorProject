import 'package:asaan/screens/temp/answerScreen.dart';
import 'package:asaan/screens/temp/questionsModal.dart';
import 'package:flutter/material.dart';
import 'package:percent_indicator/circular_percent_indicator.dart';

import '../widgets/HomeSubjectTile.dart';
import 'Quiz/questions/Alphabet_Test_Quiz.dart';
import 'Quiz/questions/Syllogism_Quiz.dart';
        ...
        TopicTile(
          ...
          onTapped: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => AlphabetTestQuiz()));
          },
        ),
        TopicTile(
          topic: "Syllogism",
          onTapped: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => SyllogismQuiz()));
          },
        ),
        Padding(
